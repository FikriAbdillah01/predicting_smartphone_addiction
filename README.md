...
Dataset di kompetisi tersebut terdiri train.csv, test.csv, dan sample_submission_csv. Data yang diolah dari train_csv terdiri dari 13 kolom dan 691369 indeks. Kolom tersebut terdiri dari:
